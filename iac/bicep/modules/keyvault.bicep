...
resource keyvault 'Microsoft.KeyVault/vaults@2023-07-01' ={
  ...
  properties:{
    ...
    accessPolicies:[
      { tenantId: subscription().tenantId
        objectId: 'af899acf-7884-4c4f-8fbd-7a0fd37e17bc' // Service Principal: fabric-deploy-sp ObjectID
        permissions: {secrets:['list','get','set']}
      }
      { tenantId: subscription().tenantId
        objectId: '9f522f5d-638b-40f0-9ac5-79d984d3d1e6' // User: Thariq ObjectID
        permissions: {secrets:['list','get','set']}
      }
