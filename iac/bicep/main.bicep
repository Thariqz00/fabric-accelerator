...
param dprg string= 'fabric-accelerator-thor-rg'

@description('Microsoft Fabric Resource group location')
param rglocation string = 'southeastasia'

@description('Cost Centre tag that will be applied to all resources in this deployment')
param cost_centre_tag string = 'MCAPS'

@description('System Owner tag that will be applied to all resources in this deployment')
param owner_tag string = 'muhamad.thariq@enfrasys.com'

@description('Subject Matter EXpert (SME) tag that will be applied to all resources in this deployment')
param sme_tag string ='muhamad.thariq@enfrasys.com'
...
param purview_name string = 'fabric-accelerator-thor-purview1' // Replace with a Globally unique name
...
param auditrg string= 'fabric-accelerator-thor-rg'
...
module kv './modules/keyvault.bicep' = {
  ...
  params:{
     ...
     keyvault_name: 'fa-dev-thor-kv01'
     cost_centre_tag: cost_centre_tag
     owner_tag: owner_tag
     sme_tag: sme_tag
...
module audit_integration './modules/audit.bicep' = if(enable_audit) {
  ...
  params:{
    ...
    owner_tag: owner_tag
    sme_tag: sme_tag
    audit_storage_name: 'fa-dev-thor-auditstorage01'
    audit_storage_sku: 'Standard_LRS'    
    audit_loganalytics_name: 'fa-dev-thor-loganalytics01'
  }
}
...
module fabric_capacity './modules/fabric-capacity.bicep' = {
  ...
  scope: fabric_rg
  params:{
    fabric_name: 'fa-dev-thor-fabriccapacity01'
    location: fabric_rg.location
    cost_centre_tag: cost_centre_tag
    owner_tag: owner_tag
    sme_tag: sme_tag
...
module controldb './modules/sqldb.bicep' = {
  ...
  scope: fabric_rg
  params:{
     sqlserver_name: 'fa-dev-thor-sql01'
     database_name: 'fa-dev-thor-controlDB' 
     location: fabric_rg.location
     cost_centre_tag: cost_centre_tag
     owner_tag: owner_tag
     sme_tag: sme_tag
